...
var _universalIdleTimeout = __webpack_require__(23);

var _universalIdleTimeout2 = _interopRequireDefault(_universalIdleTimeout);
...
var Profile = function () {
  ...
  _createClass(Profile, [{
    ...
    value: function setIdleTimer() {
      this.idleTimer = new _universalIdleTimeout2.default(function () {}, { element: document, timeout: this.intervalDuration / 2 });
      return this;
    }
  }, {
    key: 'getInstance',
...
/*! index v0.2.8 | Copyright (c) 2016-2018 Jacob Müller */
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		module.exports = factory();
	else if(typeof define === 'function' && define.amd)
...
var IdleTimeout = /** @class */ (function () {
    function IdleTimeout(callback, options) {
        ...
        this.handleEvent = function (event) {
            _this.recordUniversalLastActionTime();
    ...
    IdleTimeout.prototype.resetTimeout = function () {
        ...
        this.timeoutHandle = Number(setTimeout(function () {
            _this.handleTimeout();
    ...
    IdleTimeout.prototype.handleTimeout = function () {
        ...
        if (universalActionOccuredDuringTimeout) {
            ...
            this.isIdle = true;
            var element_1 = this.options.element;
            this.eventNames.forEach(function (eventName) {
                element_1.removeEventListener(eventName, _this.handleEvent);
            });
