...
var _idleTimeout = __webpack_require__(24);

var _idleTimeout2 = _interopRequireDefault(_idleTimeout);
...
var IdleTimeout = function () {
  ...
  _createClass(IdleTimeout, [{
    ...
    value: function setIdleTimer() {
      this.idleTimer = (0, _idleTimeout2.default)(function () {}, {
        element: document,
        timeout: 3600000
      });
      return this;
...
exports.default = new IdleTimeout();
module.exports = exports['default'];
...
var _SessionStorageDriver = __webpack_require__(8);

var _SessionStorageDriver2 = _interopRequireDefault(_SessionStorageDriver);

var _LocalStorageDriver = __webpack_require__(9);
...
var _UnTag = __webpack_require__(16);

var _UnTag2 = _interopRequireDefault(_UnTag);

var _UnFavorite = __webpack_require__(17);

var _UnFavorite2 = _interopRequireDefault(_UnFavorite);

var _Driver = __webpack_require__(18);
...
var _UidHash = __webpack_require__(19);

var _UidHash2 = _interopRequireDefault(_UidHash);

var _ReactHash = __webpack_require__(20);

var _ReactHash2 = _interopRequireDefault(_ReactHash);

var _Pride = __webpack_require__(21);
...
var _FavoritesList = __webpack_require__(25);

var _FavoritesList2 = _interopRequireDefault(_FavoritesList);

var _FavoritesSuggest = __webpack_require__(26);

var _FavoritesSuggest2 = _interopRequireDefault(_FavoritesSuggest);

var _IdleTimeout = __webpack_require__(5);
...
Object.defineProperty(Prejudice, 'IdleTimeout', { value: _IdleTimeout2.default });
...
var _PersistantStorageDriver = __webpack_require__(6);
...
var Profile = function () {
  function Profile() {
    ...
    this.idleDetection = _IdleTimeout2.default;
...
var FavoritesList = function () {
  ...
  _createClass(FavoritesList, [{
    ...
    value: function favoritedItem(datastore, id, tag) {
      var ret = {};
      var baseUrl = 'https://search.lib.umich.edu';

      if (datastore === 'mirlyn') {
        ret.id = ['http://mirlyn.lib.umich.edu/Record/' + id, baseUrl + '/catalog/record/' + id];
        ret.tags = ['mirlyn-favorite'];
        ret.type = 'mirlyn';
      } else if (datastore === 'articles') {
        ret.id = ['http://www.lib.umich.edu/articles/details/' + id, baseUrl + '/articles/record/' + id];
        ret.tags = ['articles-favorite'];
        ret.type = 'article';
      } else if (datastore === 'databases') {
        ret.id = ['http://www.lib.umich.edu/node/' + id, baseUrl + '/databases/record/' + id];
        ret.tags = ['databases-favorite'];
        ret.type = 'database';
      } else if (datastore === 'onlinejournals') {
        ret.id = ['http://mirlyn.lib.umich.edu/Record/' + id, baseUrl + '/onlinejournals/record/' + id];
