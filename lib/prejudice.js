    ...
    value: function removeFavorite(data) {
      ...
      Object.keys(data).forEach(function (datastore) {
        ...
        (data[datastore].records || []).forEach(function (id) {
          ...
          if (index >= 0) {
            dirty = true;
            this.last = this.last.slice(0, index) + this.last.slice(index + 1, this.last.length);
          }
        }, this);
      }, this);
        ...
        (data[datastore].records || []).forEach(function (id) {
          ...
          if (existing) {
            tags.forEach(function (tag) {
              ...
              if (index >= 0) {
                dirty = true;
                existing.tags = existing.tags.slice(0, index) + existing.tags.slice(index + 1, existing.tags.length);
              }
            });
          }
        }, this);
